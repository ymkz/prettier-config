...
[![renovate-badge]]([renovate-dashboard])
...
```sh
yarn add --dev prettier @ymkz/prettier-config
```

## Usage

Write the following code in `.prettierrc.yml` or `pkg.prettier`
...
[renvate-dashboard]: https://app.renovatebot.com/dashboard#github/ymkz/prettier-config
